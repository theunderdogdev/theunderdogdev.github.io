...
export const homeViewTrends = (imgName, contentText) => {
  ...
  <ul class="top-trends">
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[0]}" alt="" srcset="">
      <p>${contentText[0]}</p>
    </li>
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[1]}" alt="" srcset="">
      <p>${contentText[1]}</p>
    </li>
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[2]}" alt="" srcset="">
      <p>${contentText[2]}</p>
    </li>
  </ul>
  <ul class="top-trends">
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[3]}" alt="" srcset="">
      <p>${contentText[3]}</p>
    </li>
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[4]}" alt="" srcset="">
      <p>${contentText[4]}</p>
    </li>
    <li class="top-trend">
      <img class="rec-img" src="./static/images/${imgName[5]}" alt="" srcset="">
      <p>${contentText[5]}</p>
    </li>
  </ul>
  `;
...
export const homeRecents = (imgName, platlistTitle, platlistSubTitle) => {
  const template = `
      <li class="recent">
        <div class="album"><img src="./static/images/${imgName}" alt=""></div>
...
export const searchTopGenres = (imgNames) => {
  const template = `
      <li class="genre">
          <div class="genreinfo"><img src="./static/images/${imgNames[0]}" alt=""></div>
          <div class="genreinfo"><img src="./static/images/${imgNames[1]}" alt=""></div>
      </li>
  `;
  return template;
};
...
export const generatePlaylist = (imgName, title, description) => {
  ...
  <li class="playlist">
    <div class="wrap-cover">
        <img src="./static/images/${imgName}" alt="">
    </div>
    <div class="text-info">
